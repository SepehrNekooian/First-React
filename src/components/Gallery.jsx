...
import cardimg1 from "../../public/img/movies-2/1.jpg"
import cardimg2 from "../../public/img/movies-2/2.jpg"
import cardimg3 from "../../public/img/movies-2/3.jpg"
import cardimg4 from "../../public/img/movies-2/4.webp"
import cardimg5 from "../../public/img/movies-2/5.webp"
import cardimg6 from "../../public/img/movies-2/6.jpg"
        ...
        <div className='max-w-screen-2xl container mx-auto mt-40 px-40 '>
            ...
            <div className='flex justify-between w-full' data-aos="fade-up">
                <h2 className='text-3xl lg:text-4xl font-bold text-red'>
                    M<span className='text-white-97'>ovies</span></h2>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-20' >
                ...
                {/* {card-1} */}
                <div className='relative overflow-hidden' data-aos="fade-right">
                    ...
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>B I R D</p>
                ...
                {/* {card-2} */}
                <div className='relative lg:-mb-16 lg:mt-16 overflow-hidden'data-aos="zoom-in" >
                    <img src={cardimg2} alt="card-1" className='w-full object-cover 
                    hover:scale-95 transition-all duration-200 ease-in cursor-pointer'/>
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>THE OUTRUN</p>
                        <h3 className='text-white-97 text-sm font-medium  bg-red  hover:bg-red-600  px-5 py-2 rounded-md
                        hover:scale-95 transition-all duration-200 ease-in cursor-pointer'>WATCH</h3>
                    </div>
                </div>
                ...
                <div className='relative  overflow-hidden' data-aos="fade-left">
                    ...
                    hover:scale-95 transition-all duration-200 ease-in cursor-pointer'/>
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>HAVOC</p>
                        <h3 className='text-white-97 text-sm font-medium bg-red  hover:bg-red-600  px-5 py-2 rounded-md
                        hover:scale-95 transition-all duration-200 ease-in cursor-pointer'>WATCH</h3>
                    </div>
                </div>
            ...
            <div className='md:mt-20 mt-5' >
                ...
                <div className='relative  overflow-hidden'data-aos="fade-right">
                    ...
                    hover:scale-95 transition-all duration-200 ease-in cursor-pointer'/>
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>PLAY OR DIE</p>
                        <h3 className='text-white-97 text-sm font-medium bg-red  hover:bg-red-600  px-5 py-2 rounded-md
                        hover:scale-95 transition-all duration-200 ease-in cursor-pointer'>WATCH</h3>
                    </div>
                </div>
                ...
                <div className=' lg:-mb-16 lg:mt-16 overflow-hidden' data-aos="zoom-in">
                    <img src={cardimg5} alt="card-1" className='w-full object-cover 
                    hover:scale-95 transition-all duration-200 ease-in cursor-pointer'/>
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>SHAMAN</p>
                        <h3 className='text-white-97 text-sm font-medium bg-red  hover:bg-red-600 px-5 py-2 rounded-md
                        hover:scale-95 transition-all duration-200 ease-in cursor-pointer'>WATCH</h3>
                    </div>
                </div>
                ...
                <div className='relative  overflow-hidden' data-aos="fade-left">
                    ...
                    hover:scale-95 transition-all duration-200 ease-in cursor-pointer'/>
                    <div className='mt-4 flex justify-between items-center'>
                        <p className='text-white-97 font-bold md:text-[20px]'>OCEAN</p>
                        <h3 className='text-white-97 text-sm font-medium bg-red  hover:bg-red-600 px-5 py-2 rounded-md
                        hover:scale-95 transition-all duration-200 ease-in cursor-pointer'>WATCH</h3>
                    </div>
                </div>
